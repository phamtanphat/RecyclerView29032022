...
public class FoodModel {
    ...
    public static List<FoodModel> getMock(){
        return new ArrayList<>(Arrays.asList(
                ...
                new FoodModel(R.drawable.foody_com_tam_minh_long,"Cơm Tấm Minh Long - Nguyễn Thị Thập","607 Nguyễn Thị Thập, P. Tân Hưng, Quận 7, TP. HCM",Arrays.asList(Category.FAMILY,Category.SHOP_ONLINE),"Ca ngay - 30%",22f,Utils.createTimeToMilliSeconds(7,0),Utils.createTimeToMilliSeconds(18,0)),
                ...
                new FoodModel(R.drawable.foody_shop_online_bep_9_sach,"Bánh 9 Sạch - Bánh Sầu Riêng - Shop Online","73 An Dương Vương, P. 8,  Quận 5, TP. HCM",Arrays.asList(Category.SHOP_ONLINE,Category.GROUP,Category.FAMILY),"Ca ngay 5%",16f,Utils.createTimeToMilliSeconds(8,0),Utils.createTimeToMilliSeconds(21,9))
